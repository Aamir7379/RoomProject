...
<meta charset="ISO-8859-1">
    ...
    <title>Guest_House &mdash; Website Template by Colorlib</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0 site-logo m-0 p-0"><a href="index.html" class="mb-0">Guest_Hose</a></h1>
          </div>
          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><a href="index.html#properties-section" class="nav-link active">Room</a></li>
                <li><a href="index.html#agents-section" class="nav-link">Room_Booked</a></li>
                <li><a href="index.html#about-section" class="nav-link">About</a></li>
                <li><a href="index.html#news-section" class="nav-link">News</a></li>
                <li><a href="index.html#contact-section" class="nav-link">Login</a></li>
              </ul>
            </nav>
          </div>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-5 mx-auto mt-lg-5 text-center">
            <h1>${room.roomname}, ${room.state}, ${room.city}</h1>
            <p class="mb-5"><strong class="text-white">${room.price}</strong></p>
        ...
        <div class="row">
          <div class="col-lg-7">
            <div class="owl-carousel slide-one-item with-dots">
             <div><img src=" ${room.roomimage}" alt="Image" class="img-fluid"></div>
            </div>
          </div>
          <div class="col-lg-5 pl-lg-5 ml-auto">
            <div class="mb-5">
              <h3 class="text-black mb-4">Room Details</h3>
              <p>${room.roomview}, ${room.squarefit} sqft.</p>
              ...
              <p><button href="#" class="btn btn-primary">Book the Room</button></p>
            </div>
            ...
            <div class="mb-5">
              ...
              <div class="mt-5">
                ...
                <h4 class="text-black">Amir khan</h4>
